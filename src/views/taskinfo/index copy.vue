...
<script>
import { getTaskHandler, commitTaskHandler, checkProductUriHandler } from '@/api/operation'
...
export default {
  ...
  methods: {
    ...
    goTaskList () {
      let _this = this
      localStorage.setItem('qrOrderId', _this.qrOrderId)
      _this.$router.push({ path: '/mytask', query: { qr_order_id: _this.qrOrderId, page_name: '/taskinfo' } })
    }
  }
}
</script>
